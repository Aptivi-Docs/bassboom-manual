...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/izAJoIbtQw1BdIlE4DBz/fundamentals/what-is-bassboom
---
...
BassBoom CLI is a music player that uses the Basolia library as the backend, with Terminaux as the backend for display.
