---
description: >-
  Follow the compatibility notes when upgrading BassBoom.Basolia to API v1.0
  series
icon: up
---
...
If you are an app developer, and you plan to upgrade BassBoom.Basolia to API v1.0 version series, you'll need to consider the following breaking changes:
